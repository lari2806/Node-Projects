...
async function rollDice() { //assincrono, uma função que não acontece junto com as outras.
    return Math.floor(Math.random() *6) + 1; //Math.floor = arredonda um numero para que só saia resultados inteiros
...
//função auto invocável, ou seja, ela se chama sozinha.
(async function main(){
